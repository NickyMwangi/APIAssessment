...
namespace Data.Extensions
{
    public static class EmailServiceExtension
    {
        ...
        {
            var body = string.Concat("Dear ", firstName, ", <br/><br/>  Your registration at Asessement portal was successfull.<br/>" +
           "Please confirm your account by clicking the link below.<br/><br/> Login using your password and Email address. <br/><br/>" +
           ...
           "Thanks.<br>Best Regards<br/>Assessment Team");
            ...
            return emailService.SendEmailAsync(email, "Asessement Portal - Confirm your email", body);
        }
        ...
        public static Task<object[]> SendEmailResetPasswordAsync(this IEmailService emailService, string firstName, string email, string link)
        {
            var body = string.Concat("Dear ", firstName, ", <br/><br/> " +
                "You have recently requested to reset your password for your Asessement account.<br/>" +
            ...
            return emailService.SendEmailAsync(email, "Asessement Portal - Reset Password", body);
        }
        ...
        {
            var body = string.Concat("Dear ", firstName, ", <br/><br/> You have been created as a supplier of Asessement  Portal. Login to update your details and submit for approval. <br />" +
                "Use the link below to set your password to login or use password <strong>",password,"</strong> and Email address s as username. <br/>" +
                "Click the link below to reset it.<br/><br/>" +
                $"<a href='{HtmlEncoder.Default.Encode(link)}' " +
                @"style=""font-size: 14px; color:#FFFFFF; padding:7px;  background-color:dodgerblue"">Reset your Password</a><br/><br/>" +
                "If you did not request the password reset, kindly ignore this email or reply to us.<br/><br/>" +
