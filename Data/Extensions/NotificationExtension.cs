...
namespace Data.Extensions
{
    public static class NotificationExtension
    {
        ...
        {
            var body = string.Concat("Dear ", user.FirstName, ", <br/><br/>  Your registration at Konza Technopolis Development Authority Assessment was successfull.<br/>" +
           ...
           "Thanks.<br>Best Regards<br/>Assessment Team");

            return notification.ScheduleEmailNotificationAsync(user.Email, "Email Account Confirmation ", body, "Registration",user.Id, user.FirstName, "");
        }
        ...
        {
            var body = string.Concat("Dear ", user.FirstName, ", <br/><br/> " +
                "You have recently requested to reset your password for your Assessment account.<br/>" +
            ...
            return notification.ScheduleEmailNotificationAsync(user.Email, "Password Reset", body, "ResetPassword", user.Id, user.FirstName, "");
        }
        ...
        {
            var body = string.Concat("Dear ", user.FirstName, ", <br/><br/> You have been created as a supplier of Assessment Portal. Login to update your details and submit for approval. <br />" +
                ...
                "<b><i>This password reset is only valid for the next 30 minutes.</i></b><br/><br/>" +
                "Thanks.<br>Best Regards<br/>Assessment Team");
            return notification.ScheduleEmailNotificationAsync(user.Email, "Account Activation Request", body, "AccountActivation", user.Id, user.FirstName, "");
        }
